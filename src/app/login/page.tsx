      ...
      <div style={{ minHeight: '100vh', background: 'linear-gradient(135deg, #F0F6FF 0%, #F8F9FA 60%)', display: 'flex', flexDirection: 'column', fontFamily: 'var(--font-inter), Inter, -apple-system, sans-serif' }}>
        ...
        <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px 24px 60px' }}>
          <div style={{ width: '100%', maxWidth: 420, background: '#fff', borderRadius: 16, border: '1px solid #E3E8EF', boxShadow: '0 4px 24px rgba(0,0,0,.06)', padding: '36px 40px' }}>
            ...
            <button onClick={handleGoogleLogin} disabled={googleLoading} style={{ width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 10, padding: '11px 16px', borderRadius: 9, border: '1.5px solid #E3E8EF', background: '#fff', fontSize: 14, fontWeight: 600, color: '#202124', transition: 'border-color .15s, box-shadow .15s', marginBottom: 20, cursor: googleLoading ? 'not-allowed' : 'pointer', fontFamily: 'inherit' }}
            ...
            <div style={{ display: 'flex', background: '#F8F9FA', borderRadius: 8, padding: 3, marginBottom: 20 }}>
              {(['password', 'magic'] as const).map(t => (
                <button key={t} onClick={() => { setTab(t); setError(''); setMagicSent(false); }} style={{ flex: 1, padding: '7px 0', borderRadius: 6, border: 'none', background: tab === t ? '#fff' : 'transparent', fontSize: 13, fontWeight: 600, color: tab === t ? '#202124' : '#9AA0A6', transition: 'all .15s', boxShadow: tab === t ? '0 1px 4px rgba(0,0,0,.08)' : 'none', cursor: 'pointer', fontFamily: 'inherit' }}>
              ...
              <form onSubmit={handlePasswordLogin} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                ...
                <div>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 6 }}>
                    ...
                    <button type="button" style={{ background: 'none', border: 'none', fontSize: 12.5, color: '#1A73E8', fontWeight: 500, cursor: 'pointer', fontFamily: 'inherit' }}>Forgot password?</button>
                  </div>
            ...
            {tab === 'magic' && magicSent && (
              <div style={{ textAlign: 'center', padding: '16px 0' }}>
                ...
                <button onClick={() => setMagicSent(false)} style={{ background: 'none', border: 'none', fontSize: 13, color: '#1A73E8', fontWeight: 500, cursor: 'pointer', fontFamily: 'inherit' }}>
